...
for (j in seq(1,12)) {
  ...
  write.table(x = fusion_1, file = paste(mois[j],"moy_Ray_G_D_idem_MF", ".txt", sep = ""), col.names = TRUE)
  ...
  write.table(x = fusion_2, file = paste(mois[j], "min_Ecart-type_Max_Global_et_Diffus_idem_MF", ".txt", sep = ""), col.names = TRUE)
